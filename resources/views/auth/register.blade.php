            ...
            <div class="hidden lg:flex lg:col-span-7 relative items-center px-16 xl:px-24 overflow-hidden">
                ...
                <div class="relative z-10 max-w-xl">
                        ...
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-white" fill="none"
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M18 9v6m-3-3h6M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2h-3.172a2 2 0 01-1.414-.586l-.828-.828A2 2 0 0012.172 3H11.83a2 2 0 00-1.414.586l-.828.828A2 2 0 018.172 5H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                        </div>
                    ...
                    <p class="mt-6 text-base xl:text-lg leading-relaxed text-slate-400 max-w-md">
                        Trải nghiệm quy trình đăng ký hiện đại với hiệu ứng glassmorphism cao cấp, bảo mật mạnh mẽ và
                        giao diện giàu chiều sâu thị giác.
                    </p>
                            ...
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-white" fill="none"
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75"
                                        d="M18 9v6m-3-3h6M12 14v6m-7-3h14" />
                                </svg>
                            </div>
