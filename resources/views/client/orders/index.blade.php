                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="ml-auto">
                        <a href="{{ route('profile.edit') }}"
                           class="h-10 px-4 rounded-2xl bg-gradient-to-r from-sky-500 to-blue-600 text-white font-bold flex items-center justify-center hover:scale-[1.02] transition-all shadow-lg shadow-sky-200">
                            Quay lại
                        </a>
                    </div>
                </div>
                            ...
                            <div class="space-y-3 pt-2">
                                @foreach($order->items->take(2) as $item)
                                    @php
                                        ...
                                        $image = $product?->thumbnail ?? $item->productVariant?->image;
